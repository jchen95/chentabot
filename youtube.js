...
function playlistItemsInsert(auth, requestData) {
  ...
  service.playlistItems.insert(parameters, function(err, response) {
    ...
    console.log('Song was inserted into playlist');
  });
}
...
module.exports = {
  removeEmptyParameters:removeEmptyParameters,
  authorize:authorize,
  playlistItemsInsert: playlistItemsInsert,
  playlistItemsListByPlaylistId: playlistItemsListByPlaylistId
}
